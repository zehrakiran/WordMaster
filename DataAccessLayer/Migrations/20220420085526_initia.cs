        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WordDefinitionId1 = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_WordMeanings_Languages_WordDefinitionId",
                        column: x => x.WordDefinitionId,
                        principalTable: "Languages",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_WordMeanings_WordDefinitions_WordDefinitionId1",
                        column: x => x.WordDefinitionId1,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WordMeanings_WordDefinitionId1",
                table: "WordMeanings",
                column: "WordDefinitionId1");
        }
